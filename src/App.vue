<template>
  <div class="main-container flex flex-col px-4 py-4 dark:text-white">
    <div
      class="flex justify-center min-w-min mb-2 mt-1 sm:mb-4 sm:mt-2 relative"
    >
      <div class="handyv-logo select-none">
        <svg
          width="349.707"
          height="93.116"
          ...
          >
            <path
              ...
              :style="`
                --color1: #f59422;
                --color2: #fdc608;
                ${store.state.dark ? '--color1: #22bdf5;' : ''}
                ${store.state.dark ? '--color2: #0060bf;' : ''}
                fill: var(--color2);
                stroke: var(--color2);
                filter: drop-shadow(var(--color1) -5px 3px);
              `"
            ></path>
          </g>
        </svg>
...
.main-container {
  @apply min-h-screen;
  @apply bg-gradient-to-br from-white to-blueGray-100;
  @apply dark:from-blueGray-900 dark:to-gray-800;
}
